      ...
      {/* image */}
        <div className='flex flex-col md:flex-row md:items-center md:space-x-12 -space-y-24 lg:-space-y-0'>
          ...
          <h2 className='h1 md:text-[60px] md:leading-[62px] mb-4 lg:mb-6 text-white'>
            Want join <span className='text-primary-200'> & </span> and have fun?
          </h2>
          <p className='text-body-sm text-white md:text-body-md mb-4 lg:mb-5 max-w-[348px] md:max-w-[470px] lg:max-w-[492px]'>{subtitle}</p>
