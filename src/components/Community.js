...
const Community = () => {
  ...
  return <section className='section relative'>
    <div className='container mx-auto'>
      <div className='flex'>
          {/* section title */}
        <div className='section-title-group max-w-[240px] px-4 lg:px-0 lg:ml-0 mx-auto' data-aos='fade-up'
        data-aos-offset='200'
        data-aos-delay='200'
        > 
        ...
        {/* slider */}
        <div className='absolute -rigth-[375px] lg:-right-[280px] w-[1140px] top-48 lg:top-0'
        data-aos='fade-left'
        data-aos-offset='100'
        data-aos-delay='100'>
